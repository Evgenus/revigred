...
(function() {
  ...
  define([], function() {
    ...
    return root.Segment = (function() {

      function Segment(v1, v2) {
        this.v1 = v1;
        this.v2 = v2;
        this.line = root.Line.from_vectors(this.v1, this.v2);
      }
  ...
  define(['Backbone.Model', 'Backbone.Collection'], function() {
    var collections, gizmos, root, views;
    ...
    root.GraphModel = (function(_super) {
      ...
      GraphModel.prototype.add = function() {
        ...
        for (_i = 0, _len = nodes.length; _i < _len; _i++) {
          node = nodes[_i];
          if (!isinstance(node, root.NodeModel, gizmos.Gizmo)) {
            throw "Invalid type";
          }
        }
      ...
      GraphModel.prototype.pick_end = function(view) {
        if (isinstance(this.cursor_object, views.ConnectorView)) {
          if (this.cursor_object === view) {
            return this.drop_start(view);
          } else {
            this.gizmos.push(new gizmos.EdgeGizmo(view, this.cursor_object));
    ...
    root.NodeModel = (function(_super) {
      ...
      NodeModel.prototype.add = function() {
        ...
        for (_i = 0, _len = connectors.length; _i < _len; _i++) {
          ...
          if (!isinstance(connector, root.ConnectorModel)) {
            throw "Invalid type";
          }
        }
    ...
    root.ConnectorModel = (function(_super) {
    ...
    root.LeftConnectorModel = (function(_super) {
    ...
    return root.RightConnectorModel = (function(_super) {
  ...
  define(['revigred.models.LeftConnectorModel', 'revigred.models.RightConnectorModel'], function() {
    var models, root;
    root = namespace("revigred.collections");
    models = namespace("revigred.models");
    root.NodesList = (function(_super) {
    ...
    root.ConnectorsList = (function(_super) {
    ...
    root.LeftConnectorsList = (function(_super) {
    ...
    return root.RightConnectorsList = (function(_super) {
