...
(function() {
  ...
  define("revigred.controller", [], function() {
    ...
    controller.Controller = (function() {
      ...
      Controller.prototype.get_node_view = function(node) {
        var _base, _name;
        return (_base = this._node_views)[_name = node.id] != null ? (_base = this._node_views)[_name = node.id] : _base[_name] = new views.NodeView({
          model: node
        });
      };
  ...
  define(['Backbone.Model'], function() {
    var collections, delay, gizmos, models, _ref, _ref1, _ref2;
    models = namespace("revigred.models");
    ...
    models.EchoChannel = (function() {
      function EchoChannel(model) {
        ...
        this.model.on("createNode", function(node) {
    ...
    models.NodeModel = (function(_super) {
      ...
      NodeModel.prototype.get_connector = function(name) {
        var _this = this;
        return this.connectors.find(function(connector) {
    ...
    models.ConnectorModel = (function(_super) {
      ...
      function ConnectorModel() {
        _ref = ConnectorModel.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    models.InputConnectorModel = (function(_super) {
      ...
      function InputConnectorModel() {
        _ref1 = InputConnectorModel.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
    ...
    models.OutputConnectorModel = (function(_super) {
      ...
      function OutputConnectorModel() {
        _ref2 = OutputConnectorModel.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
  ...
  define("revigred.collections", ['Backbone.Collection', 'revigred.models.NodeModel'], function() {
    var collections, models, _ref, _ref1;
    models = namespace("revigred.models");
    collections = namespace("revigred.collections");
    ...
    this.ConnectorsList = (function(_super) {
      ...
      function ConnectorsList() {
        _ref = ConnectorsList.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    return this.ConnectionsList = (function(_super) {
      ...
      function ConnectionsList() {
        _ref1 = ConnectionsList.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
  ...
  define(["Backbone.View"], function() {
    var controller, gizmos, models, settings, views, _ref, _ref1, _ref2, _ref3, _ref4;
    views = namespace("revigred.views");
    math = namespace("Math");
    ...
    views.GraphView = (function(_super) {
      ...
      GraphView.prototype.render = function(callback) {
        var $window,
          _this = this;
        $window = $(window).on('keydown.revigred', function(event) {
          return _this.$el.focus().on('keyup.revigred', function(event) {
    ...
    views.GraphCanvasView = (function(_super) {
      ...
      function GraphCanvasView() {
        _ref = GraphCanvasView.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      GraphCanvasView.prototype.draw = function(callback) {
        ...
        return this.model.nodes.forEach(function(node) {
          var view;
    ...
    views.NodeView = (function(_super) {
      ...
      function NodeView(options) {
        ...
        this.model.set_bounds(function() {
          return _this.bounds();
        });
      ...
      NodeView.prototype._on_mousedown = function(event) {
        var _this = this;
        this.dragged = false;
        return this.model.graph.nodes.set_dragging_callback(function() {
    ...
    views.LeftConnectorsView = (function(_super) {
      ...
      function LeftConnectorsView() {
        _ref1 = LeftConnectorsView.__super__.constructor.apply(this, arguments);
        return _ref1;
      }
    ...
    views.RightConnectorsView = (function(_super) {
      ...
      function RightConnectorsView() {
        _ref2 = RightConnectorsView.__super__.constructor.apply(this, arguments);
        return _ref2;
      }
    ...
    views.ConnectorView = (function(_super) {
      ...
      function ConnectorView(options) {
        ...
        this.model.set_position(function() {
          return _this._pos();
        });
        this.model.on("remove", this.remove, this);
      }
      ...
      ConnectorView.prototype._on_mousedown = function(event) {
        var _ref3;
        if ((_ref3 = this.model.node.graph) != null) {
          _ref3.pick_start(this.model);
        }
        return false;
      };
    ...
    views.LeftConnectorView = (function(_super) {
      ...
      function LeftConnectorView() {
        _ref3 = LeftConnectorView.__super__.constructor.apply(this, arguments);
        return _ref3;
      }
    ...
    views.RightConnectorView = (function(_super) {
      ...
      function RightConnectorView() {
        _ref4 = RightConnectorView.__super__.constructor.apply(this, arguments);
        return _ref4;
      }
    ...
    return views.ConnectionsView = (function(_super) {
      ...
      ConnectionsView.prototype.render_canvas = function(ctx) {
        var conn, _i, _len, _ref5;
        ctx.strokeStyle = "rgb(0,0,0)";
        ctx.lineWidth = 2;
        ctx.beginPath();
        _ref5 = this.connections;
