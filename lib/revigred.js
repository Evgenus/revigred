...
(function() {
  ...
  define(["revigred.models.NodeModel", "revigred.models.GraphModel"], function() {
    ...
    flow.FlowNode = (function(_super) {
      ...
      function FlowNode(options) {
        ...
        for (name in this.inputs) {
          ...
          this.add(new models.InputConnectorModel(data));
        }
        for (name in this.outputs) {
          ...
          this.add(new models.OutputConnectorModel(data));
        }
      }
    ...
    flow.Tlke = (function(_super) {
      __extends(Tlke, _super);

      function Tlke() {
        return Tlke.__super__.constructor.apply(this, arguments);
      }

      Tlke.prototype.title = "TLKE";

      Tlke.prototype.inputs = {
        generate: {},
        enterOffer: {},
        enterAuth: {},
        processPacket: {}
    ...
    flow.Route = (function(_super) {
      ...
      Route.prototype.title = "Route";

      Route.prototype.inputs = {
        setAddr: {},
        processPacket: {},
        processNetworkPacket: {}
      };

      Route.prototype.outputs = {
        packet: {},
        networkPacket: {}
      };
    ...
    return flow.Transport = (function(_super) {
      ...
      Transport.prototype.title = "Transport";

      Transport.prototype.inputs = {
        openAddr: {},
        sendNetworkPacket: {}
      };

      Transport.prototype.outputs = {
        networkPacket: {}
      };
