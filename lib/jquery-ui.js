/*! jQuery UI - v1.11.0pre - 2014-04-01
* http://jqueryui.com
...
return $.widget("ui.mouse", {
	...
	_mouseDown: function(event) {
		...
		this._contextMenuDelegate = function(event) {
			event.preventDefault();
			return false;
		};
		...
		this.document
			...
			.bind( "contextmenu." + this.widgetName, this._contextMenuDelegate )
			;
	...
	_mouseUp: function(event) {
		this.document
			.unbind( "mousemove." + this.widgetName, this._mouseMoveDelegate )
			.unbind( "mouseup." + this.widgetName, this._mouseUpDelegate )
			.unbind( "contextmenu." + this.widgetName, this._contextMenuDelegate )
			;
